// <![CDATA[
    ...
    var colour_drops="transparent"; //  colours of drops
    var border="transparent"; // colour of border
    var speed=40; // speed of animation, lower is faster
    var size=1; // size of blocks
    ...
    ****************************/
    ...
    function brilhos () { if (document.getElementById) {
      ...
      for (i=0; i<drops; i++) {
        ...
        s.position="absolute";
        s.visibility="hidden";
        s.backgroundColor=colour_drops;
    ...
    function mainblock(r) {
      var t, l;
      t=4+size*Math.floor(Math.random()*(shigh_drops-size)/size);
      l=4+size*Math.floor(Math.random()*(swide_drops-size)/size);
